...
let _cities = require('util/cities/city.js');
let _address = require('service/address-service.js');
let templateAddressModel = require('./address-model.string');
...
let addressModel = {
  ...
  // 加载弹出框
  loadModel: function() {
    let addressModelHtml = _util.renderHtml(templateAddressModel, {
